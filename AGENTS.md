...
- Keep the tea counter at the approved compact `58% × 16%` size and right alignment; its current vertical position is `top: 8%`, the lowest placement that puts its base on the floor without overlapping the boss home anchor.
