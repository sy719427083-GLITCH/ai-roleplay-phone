...
const worldbookAsset = (fileName) => `${import.meta.env.BASE_URL}worldbook-assets/${fileName}?v=0.2.91`;
const workMapAsset = (fileName) => `${import.meta.env.BASE_URL}work-map-assets/${fileName}?v=0.2.91`;
const workTravelerAsset = (asset) => `${import.meta.env.BASE_URL}${asset}?v=0.2.91`;
...
function SettingsScreen({ onOpen }) {
  return (
    <section className="screen-view settings-view">
      ...
      <p className="version-label">Ccat OS V0.2.91</p>
    </section>
  );
}
