...
const worldbookAsset = (fileName) => `${import.meta.env.BASE_URL}worldbook-assets/${fileName}?v=0.2.81`;
const workMapAsset = (fileName) => `${import.meta.env.BASE_URL}work-map-assets/${fileName}?v=0.2.81`;
const workOutlineAsset = (themeId, placeType) => `${import.meta.env.BASE_URL}work-map-outlines/${themeId}-${placeType}.png?v=0.2.81`;
...
function SettingsScreen({ onOpen }) {
  return (
    <section className="screen-view settings-view">
      ...
      <p className="version-label">Ccat OS V0.2.81</p>
    </section>
  );
}
