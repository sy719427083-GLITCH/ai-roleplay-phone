...
export const OFFICE_ACTIVITY_MANIFEST = Object.freeze({
  ...
  whiteboardWork: definition({ id: "whiteboardWork", sceneId: "office", targetAnchors: ["whiteboard:1", "whiteboard:2"], clips: { actor: "whiteboard-writing", host: "whiteboard-writing", visitor: "whiteboard-discussing" }, status: "白板讨论中", travelStatus: "前往白板", participants: { min: 2, max: 3 }, propState: { category: "whiteboard", variants: ["marker", "sticky-notes"] }, semanticFallback: { subject: "方案梳理", summary: "围绕白板拆解问题", insightOrResult: "形成可执行的分工" } }),
  reporting: definition({ id: "reporting", sceneId: "office", targetAnchors: ["boss:seat-approach", "boss:visitor-front"], clips: { actor: "reporting", host: "reporting", visitor: "listening" }, status: "汇报中", travelStatus: "前往主管工位", participants: { min: 2, max: 2 }, requiredActorIds: ["boss"], propState: { category: "report", variants: ["report"] }, semanticFallback: { subject: "项目进度", summary: "汇总当前进展与风险", insightOrResult: "确认下一阶段重点" } }),
  ...
  documentDelivery: definition({ id: "documentDelivery", sceneId: "office", targetAnchors: ["boss:seat-approach", "boss:visitor-front"], clips: { actor: "document-submit", host: "document-submit", visitor: "document-sign" }, status: "文件递交中", travelStatus: "前往签收工位", participants: { min: 2, max: 2 }, propState: { category: "documents", variants: ["contract"] }, semanticFallback: { subject: "待签文件", summary: "递交文件并确认内容", insightOrResult: "完成签收流程" } }),
  documentSigning: definition({ id: "documentSigning", sceneId: "office", targetAnchors: ["boss:seat-approach"], clips: { actor: "document-sign" }, status: "签署中", travelStatus: "前往签署工位", propState: { category: "documents", variants: ["contract", "pen"] }, semanticFallback: { subject: "签署文件", summary: "核对条款后签署", insightOrResult: "完成审批节点" } }),
  ...
  chatting: definition({ id: "chatting", sceneId: "office", targetAnchors: ["whiteboard:1", "whiteboard:2"], clips: { actor: "chatting", host: "chatting", visitor: "listening" }, status: "交流中", travelStatus: "前往交流区", participants: { min: 2, max: 3 }, propState: { category: "conversation", variants: ["project", "lunch", "weekend"] }, semanticFallback: { subject: "办公室交流", summary: "围绕手头话题交换看法", insightOrResult: "找到可继续讨论的方向" } }),
});
