...
export const OFFICE_ACTIVITY_MANIFEST = Object.freeze({
  ...
  drinking: definition({ id: "drinking", sceneId: "lounge", targetAnchors: ["sofa:seat-2"], clips: { actor: "drinking" }, status: "喝饮料中", travelStatus: "前往沙发区", propState: { category: "drink", variants: ["coffee", "water"] }, semanticFallback: { subject: "饮品", summary: "坐下来喝点饮品", insightOrResult: "恢复一点精神" } }),
  coffeeBreak: definition({ id: "coffeeBreak", sceneId: "lounge", targetAnchors: ["pantry:coffee"], clips: { actor: "drinking" }, status: "冲咖啡中", travelStatus: "前往茶水间", propState: { category: "drink", variants: ["coffee"] }, semanticFallback: { subject: "咖啡时间", summary: "在茶水间冲一杯咖啡", insightOrResult: "稍微恢复了精神" } }),
  waterBreak: definition({ id: "waterBreak", sceneId: "lounge", targetAnchors: ["pantry:water"], clips: { actor: "drinking" }, status: "喝水中", travelStatus: "前往饮水区", propState: { category: "drink", variants: ["water"] }, semanticFallback: { subject: "补充水分", summary: "在饮水区喝点水", insightOrResult: "补充水分后更清醒" } }),
  watchingTv: definition({ id: "watchingTv", sceneId: "lounge", targetAnchors: ["sofa:seat-2"], clips: { actor: "watching-tv" }, status: "看电视中", travelStatus: "前往电视区", propState: { category: "television", variants: ["news", "show"] }, semanticFallback: { subject: "电视节目", summary: "在休息区看一会儿电视", insightOrResult: "短暂转换了注意力" } }),
  sofaRest: definition({ id: "sofaRest", sceneId: "lounge", targetAnchors: ["sofa:seat-2"], clips: { actor: "sofa-rest" }, status: "沙发休息中", travelStatus: "前往沙发区", propState: { category: "rest", variants: ["none"] }, semanticFallback: { subject: "短暂休息", summary: "在沙发上放松片刻", insightOrResult: "恢复专注力" } }),
  quietRest: definition({ id: "quietRest", sceneId: "lounge", targetAnchors: ["sofa:seat-2"], clips: { actor: "quiet-rest" }, status: "安静休息中", travelStatus: "前往安静区", propState: { category: "rest", variants: ["none"] }, semanticFallback: { subject: "安静片刻", summary: "暂时离开屏幕和噪音", insightOrResult: "理清了思绪" } }),
  ...
  sofaChat: definition({ id: "sofaChat", sceneId: "lounge", targetAnchors: ["sofa:seat-1", "sofa:seat-3"], clips: { actor: "sofa-chat", host: "sofa-chat", visitor: "sofa-listen" }, status: "沙发聊天中", travelStatus: "前往沙发区", participants: { min: 2, max: 2 }, propState: { category: "conversation", variants: ["coffee"] }, semanticFallback: { subject: "休息聊天", summary: "在沙发边聊聊近况", insightOrResult: "缓和了工作节奏" } }),
  chatting: definition({ id: "chatting", sceneId: "office", targetAnchors: ["whiteboard:1", "whiteboard:2", "whiteboard:3"], clips: { actor: "chatting", host: "chatting", visitor: "listening" }, status: "交流中", travelStatus: "前往交流区", participants: { min: 2, max: 4 }, propState: { category: "none", variants: ["none"] }, semanticFallback: { subject: "办公室交流", summary: "围绕手头话题交换看法", insightOrResult: "找到可继续讨论的方向" } }),
});
