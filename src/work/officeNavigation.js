...
export const OFFICE_NODES = Object.freeze({
  ...
  "employee3-exit": createNode("employee3-exit", 45, 71, ["employee3-home", "meeting-1"]),
  "employee4-home": createNode("employee4-home", 76, 71, ["employee4-exit"]),
  "employee4-exit": createNode("employee4-exit", 60, 71, ["employee4-home", "meeting-1"]),
  "aisle-upper": createNode("aisle-upper", 52, 58, [
    "employee1-exit",
    "employee2-exit",
    "boss-exit",
    "aisle-lower",
  ...
  "chat-3": createNode("chat-3", 47, 82, ["meeting-1"]),
  "chat-4": createNode("chat-4", 58, 82, ["meeting-1"]),
  "meeting-1": createNode("meeting-1", 52, 71, [
    "employee3-exit",
    "employee4-exit",
    "aisle-upper",
    "aisle-lower",
