...
export const OFFICE_ACTIVITY_POINTS = Object.freeze({
  ...
  "chat-1": Object.freeze({ x: 34, y: 84 }),
  "chat-2": Object.freeze({ x: 45, y: 84 }),
  "chat-3": Object.freeze({ x: 55, y: 84 }),
  "chat-4": Object.freeze({ x: 66, y: 84 }),
  "rest-left": Object.freeze({ x: 13, y: 34 }),
  "rest-right": Object.freeze({ x: 87, y: 34 }),
